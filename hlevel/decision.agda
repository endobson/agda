...
opaque
  ...
  isPropDec ha (no ¬a1) (no ¬a2) = cong no (isProp¬ ¬a1 ¬a2)
  ...
  isProp-Tri ha hb hc (tri< a1 b1 c1) (tri< a2 b2 c2) i =
    tri< (ha a1 a2 i) (isProp¬ b1 b2 i) (isProp¬ c1 c2 i)
  isProp-Tri ha hb hc (tri= a1 b1 c1) (tri= a2 b2 c2) i =
    tri= (isProp¬ a1 a2 i) (hb b1 b2 i) (isProp¬ c1 c2 i)
  isProp-Tri ha hb hc (tri> a1 b1 c1) (tri> a2 b2 c2) i =
    tri> (isProp¬ a1 a2 i) (isProp¬ b1 b2 i) (hc c1 c2 i)
