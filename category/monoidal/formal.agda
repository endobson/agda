...
dirpath-to-canon' {n} o@((o1 ⊗ o2) ⊗ o3) lt = handle lt
  where
  ...
  lt2 : (WObj-rank (o1 ⊗ (o2 ⊗ o3))) < (WObj-rank ((o1 ⊗ o2) ⊗ o3))
  lt2 = (b o1) , +'-right-suc >=> (sym branch-path)

  handle : {n : Nat} -> (WObj-rank ((o1 ⊗ o2) ⊗ o3)) ≤ n -> DirectedPath true o (canon o)
  handle {zero} lt = bot-elim (zero-≮ (trans-<-≤ lt2 lt))
  handle {suc n} lt =
    transport (\i -> DirectedPath true o (c1=c2 (~ i)))
      ((α⇒' o1 o2 o3 , α⇒' o1 o2 o3) :: (dirpath-to-canon' {n} (o1 ⊗ (o2 ⊗ o3)) lt3))
    where

    lt3 : WObj-rank (o1 ⊗ (o2 ⊗ o3)) ≤ n
    lt3 = pred-≤ (trans-<-≤ lt2 lt)
