...
open import category.example using ()
open import category.example-discrete using ()
open import category.example2 using ()
open import category.example3 using ()
...
open import category.iterated-product-eq using ()
...
open import category.monoidal.formal.assoc using ()
open import category.monoidal.formal.base using ()
open import category.monoidal.formal.category using ()
open import category.monoidal.formal.clean using ()
open import category.monoidal.formal.clean-mor using ()
open import category.monoidal.formal.directed using ()
open import category.monoidal.formal.factor using ()
open import category.monoidal.formal.factor2 using ()
open import category.monoidal.formal.isomorphism using ()
open import category.monoidal.formal.to-canon using ()
open import category.monoidal.functor using ()
open import category.monoidal.semicartesian using ()
...
open import category.swap-product-eq using ()
open import category.term-product-eq using ()
