...
module _ {ℓB ℓC : Level} {B : Type ℓB} {C : Type ℓC} {{SB : Semiring B}} {{SC : Semiring C}} where
  ...
  abstract
    ...
    finiteProduct-homo-inject FA {f = f} fʰ =
      finiteProductᵉ-path >=>
      finiteMerge-homo-inject CM-C SC.isSetDomain FA CM-B SB.isSetDomain fʰ >=>
